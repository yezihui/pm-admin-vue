<template>
  <div
    class="slide-verify animated fadeIn"
    id="slideVerify"
...
.slide-verify-close-icon {
  ...
  height: 34px;
  cursor: pointer;
  //   background: url("../../../assets/images/verify-img/icon_light.png") 10px -540px;
...
.slide-verify-refresh-icon {
  ...
  height: 34px;
  cursor: pointer;
  background: url("../../../assets/images/verify-img/icon_light.png") 0 -437px;
  background-size: 34px 471px;
}
.slide-verify-slider {
  position: relative;
...
.slide-verify-slider-mask-item-icon {
  ...
  width: 14px;
  height: 12px;
  background: url("../../../assets/images/verify-img/icon_light.png") 0 -26px;
  background-size: 34px 471px;
}
